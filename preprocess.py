...
def Encode_HSI(HSI_np):
    ...
    sio.savemat('HSI_Encoded.mat', {'data': HSI_feature_np})
    print()
...
# LiDAR_np = sio.loadmat('./other data/LiDAR_interpolated.mat')['data']
# HSI_np = sio.loadmat('./HSI_interpolated.mat')['data']
# Encoded_LiDAR = Encode_3D(LiDAR_np)
# sio.savemat('LiDAR_Encoded.mat', {'data': Encoded_LiDAR})
# Encode_HSI(HSI_np)
# print()
